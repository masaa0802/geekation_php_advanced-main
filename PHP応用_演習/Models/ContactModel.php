...
class Model
{
    ...
    public function insertData($name, $kana, $tel, $email, $body)
    {
        try {
            ...
            $this->pdo->beginTransaction();
            // SQL作成
            $stmt = $this->pdo->prepare("INSERT INTO contacts (name, kana, tel, email, body) 
    ...
    public function updateData($id, $name, $kana, $tel, $email, $body)
    {
        try {
            ...
            $this->pdo->beginTransaction();
            // SQL作成
            $stmt = $this->pdo->prepare("UPDATE contacts 
            SET name = :name, kana = :kana, tel = :tel, email = :email , body = :body WHERE id = :id");
